...
def _create_alpha(
    ...
    """
    Create canonical continuous alpha from BUY probability.
    ...
    Confidence:
        abs(Probability - 0.50) * 2

    IMPORTANT
    ---------
    Proba is authoritative.

    Prediction_Alpha and Alpha_Score are NOT used as the
    primary probability source because they may represent
    already-transformed or filtered values.
    """
    ...
    # --------------------------------------------------------
    # 2. Probability is authoritative
    # --------------------------------------------------------
